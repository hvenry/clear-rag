 ...
 * pages answer "why does this stage exist at all".
 */
    ...
    <article className="reveal mx-auto max-w-2xl px-4 py-6 sm:px-6 sm:py-8">
      ...
      {topic.seeIt ? (
        <aside className="mt-6 border-l-2 border-foreground/40 pl-3">
          <div className="font-display text-[9px] tracking-[0.18em] text-subtle uppercase">
            See it live
          </div>
...
/** Renders `backticked` spans as inline code; everything else as plain text. */
